...
const websiteSchema = {
  ...
  name: 'Mokta\'b | مكتئب',
  alternateName: 'مكتئب',
  description: 'منصة تعليمية متطورة لإنشاء وإجراء الاختبارات عبر الإنترنت مع أدوات تحليل متقدمة',
  url: baseUrl,
  potentialAction: {
    '@type': 'SearchAction',
...
export const metadata: Metadata = {
  ...
  description: 'منصة تعليمية متطورة لإنشاء وإجراء الاختبارات عبر الإنترنت. أدوات تحليل متقدمة، تقارير تفصيلية، وتجربة تعليمية فريدة للمعلمين والطلاب.',
  keywords: [
    'اختبارات تعليمية',
    'منصة تعليمية',
  ...
  openGraph: {
    ...
    description: 'منصة تعليمية متطورة لإنشاء وإجراء الاختبارات عبر الإنترنت مع أدوات تحليل متقدمة وتقارير تفصيلية.',
    url: baseUrl,
    siteName: 'Mokta\'b',
    images: [
      {
  ...
  other: {
    'google-site-verification': '', // يجب إضافة رمز التحقق من Google Search Console
